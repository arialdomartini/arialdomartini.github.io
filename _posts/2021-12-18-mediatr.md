...
Do not be deceived by the academic reference. This will not be an exercise in style: indeed, all the MediatR's issues stem from the fact it deviates from the standard way the Mediator Pattern is traditionally implemented.
