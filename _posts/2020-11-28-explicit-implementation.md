---
layout: post
title: "Interfaces should always be implemented explicitely"
...
* I tried to promote Explicit Implementation wherever possible
* I figured out that there are not so many cases for Implicit Implementation Object. After all, objects should be manipulated solely in terms of their interface, rather than in terms of their concrete types. 
